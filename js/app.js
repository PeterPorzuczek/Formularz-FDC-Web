...
const disabilityOptions   = [
                                { name: "Nie posiada orzeczenia o niepełnosprawności", code: "0"},
...
const relativesCountSection = (num) =>  ([
                    {
                        "value"     :"Rozpocznij",
                        "type"      :"head",
...
const employeeIdentificationSection = (num) =>  ([
                    {
...
const relativeIdentificationSection = (num) =>  ([
                    {
                    ...
                    },
                    {
                        ...
                        "choices"   :[
                                        ...
                                        [
                                            ...
                                            yesNoOptions.yes.name
                                        ],
                                        [
                                            yesNoOptions.no.value,
                                            yesNoOptions.no.name
                                        ]
                                     ],
                        "type": "select",
                        "num"       :num
                    ...
                    },
                    {
                        ...
                        "choices"   :[
                                        ...
                                        [
                                            relationshipOptions[0].name,
                                            relationshipOptions[0].name
                                        ],
                                        [
                                            relationshipOptions[1].name,
                                            relationshipOptions[1].name
                                        ],
                                        [
                                            relationshipOptions[2].name,
                                            relationshipOptions[2].name
                                        ],
                                        [
                                            relationshipOptions[3].name,
                                            relationshipOptions[3].name
                                        ],
                                        [
                                            relationshipOptions[4].name,
                                            relationshipOptions[4].name
                                        ],
                                        [
                                            relationshipOptions[5].name,
                                            relationshipOptions[5].name
                                        ],
                                        [
                                            relationshipOptions[6].name,
                                            relationshipOptions[6].name
                                        ],
                                        [
                                            relationshipOptions[7].name,
                                            relationshipOptions[7].name
                                        ],
                                        [
                                            relationshipOptions[8].name,
                                            relationshipOptions[8].name
                                        ],
                                        [
                                            relationshipOptions[9].name,
                                            relationshipOptions[9].name
                                        ],
                                        [
                                            relationshipOptions[10].name,
                                            relationshipOptions[10].name
                                        ]
                                     ],
                        "type": "select",
                    ...
                    },
                    {
                        ...
                        "choices"   :[
                                        ...
                                        [
                                            disabilityOptions[0].name,
                                            disabilityOptions[0].name
                                        ],
                                        [
                                            disabilityOptions[1].name,
                                            disabilityOptions[1].name
                                        ],
                                        [
                                            disabilityOptions[2].name,
                                            disabilityOptions[2].name
                                        ],
                                        [
                                            disabilityOptions[3].name,
                                            disabilityOptions[3].name
                                        ],
                                        [
                                            disabilityOptions[4].name,
                                            disabilityOptions[4].name
                                        ]
                                     ],
                        "type": "select",
...
const relativeAddressSection = (num) =>  ([
                    {
                    ...
                    },
                    {
                        ...
                        "choices"   :[
                                        ...
                                        [
                                            voivodeshipOptions[0].value,
                                            voivodeshipOptions[0].name
                                        ],
                                        [
                                            voivodeshipOptions[1].value,
                                            voivodeshipOptions[1].name
                                        ],
                                        [
                                            voivodeshipOptions[2].value,
                                            voivodeshipOptions[2].name
                                        ],
                                        [
                                            voivodeshipOptions[3].value,
                                            voivodeshipOptions[3].name
                                        ],
                                        [
                                            voivodeshipOptions[4].value,
                                            voivodeshipOptions[4].name
                                        ],
                                        [
                                            voivodeshipOptions[5].value,
                                            voivodeshipOptions[5].name
                                        ],
                                        [
                                            voivodeshipOptions[6].value,
                                            voivodeshipOptions[6].name
                                        ],
                                        [
                                            voivodeshipOptions[7].value,
                                            voivodeshipOptions[7].name
                                        ],
                                        [
                                            voivodeshipOptions[8].value,
                                            voivodeshipOptions[8].name
                                        ],
                                        [
                                            voivodeshipOptions[9].value,
                                            voivodeshipOptions[9].name
                                        ],
                                        [
                                            voivodeshipOptions[10].value,
                                            voivodeshipOptions[10].name
                                        ],
                                        [
                                            voivodeshipOptions[11].value,
                                            voivodeshipOptions[11].name
                                        ],
                                        [
                                            voivodeshipOptions[12].value,
                                            voivodeshipOptions[12].name
                                        ],
                                        [
                                            voivodeshipOptions[13].value,
                                            voivodeshipOptions[13].name
                                        ],
                                        [
                                            voivodeshipOptions[14].value,
                                            voivodeshipOptions[14].name
                                        ],
                                        [
                                            voivodeshipOptions[15].value,
                                            voivodeshipOptions[15].name
                                        ]
                                     ],
                        "type": "select",
                        "num"       :num
...
const locationIdentificationSection = (num) =>  ([
                    {
...
function setRelatives(fields) {
    const   relativesFieldId = fields[1].id;
...
function dataGet(formArray){
    ...
    const sectionsCount = parseInt(relativesCount) + 2;
...
function generateEmptyBlob(empty, data) {
    return generate("blob", empty, data)
        .then(function (blob) {
...
function generate(type, empty, data) {
    return getWorkbookFromResponse()
...
function formPostGenerationPreparation(formArray) {
    ...
    const map = document.getElementById( containers.map );
    if ( map ) {
    ...
    formArray.forEach(function(entry) {
        ...
        if (entry.formId){
            ...
            //documentOptionHide
            if( entry.formId.includes( formGroupIdPrefix.relativeDocument1 ) || 
                entry.formId.includes( formGroupIdPrefix.relativeDocument2 )) {
            ...
            const externalAddressFormGroups =   [   formGroupIdPrefix.relativeAddressSectionTitle,
                                                    formGroupIdPrefix.relativeVoivodeship,
                                                    formGroupIdPrefix.relativeCommunity,
                                                    formGroupIdPrefix.relativePlace,
                                                    formGroupIdPrefix.relativePostal,
                                                    formGroupIdPrefix.relativeStreet,
                                                    formGroupIdPrefix.relativeFlatNumber,
                                                    formGroupIdPrefix.relativeApartmentNumber,
                                                    formGroupIdPrefix.relativeTelephoneNumber
                                                ]
                ...
                $( "#" + entry.id ).change(function(){
                    ...
                    for (var i = 0; i < externalAddressFormGroups.length; i++) {
                        ...
                        if(externalAddressFormGroups[i].includes("TextboxFormGroupID")){
                            const name = externalAddressFormGroups[i].split( "TextboxFormGroupID" )[0];
